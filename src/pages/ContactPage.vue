  ...
  <q-page padding class="q-gutter-md">
    <section class="dasm-shell">
      ...
      <div class="dasm-shell__content">
        <div class="dasm-caps">Contact</div>
        <h1 class="dasm-title">From requirements to MVP, let’s build it properly</h1>
        <p class="dasm-subtitle">
          If you are evaluating an idea, modernizing architecture, or moving a prototype toward delivery,
          we can work through scope, trade-offs, and execution together.
        </p>
      </div>
    </section>
